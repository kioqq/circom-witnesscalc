...
use compiler::intermediate_representation::ir_interface::{
    ...
    Instruction, InstructionPointer, LoadBucket, LocationRule, ObtainMeta, OperatorType,
    ReturnBucket, ReturnType, StatusInput, StoreBucket, ValueBucket, ValueType,
};
...
fn store_subcomponent_signals(
    ...
    let sub_cmp = subcomponents[subcomponent_idx].as_mut().unwrap();
